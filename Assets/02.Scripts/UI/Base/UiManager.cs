...
namespace act.ui
{
    public class UiManager : SingletonMonoBehavior<UiManager>
    {
        ...
        public Texture GetTexture(string textureType, string textureName)
        {
            return utility.LoadResources.LoadAsset<Texture>($"{data.ResourcesPathSetting.Textures}{textureType}{textureName}");
        }
        #endregion
